...
const NodeStyling = (props) => {
  ...
  const { classes, size, backgroundColor, borderColor } = props;
  ...
  return (
    <Paper className={classes.root}>
      ...
      <div className={classes.row}>
        ...
        >
          {t("nodes.node-styling.large")}
        </Button>
      </div>
      <div className={classes.row}>
        <Typography variant="subtitle2">{t("nodes.node-styling.color")}</Typography>
      ...
      <div className={classes.row}>
        ...
        <div className={classes.swatch} onClick={handleClickBorder}>
          <div
            className={classes.color}
            style={{
              backgroundColor: `rgba(${borderColor.r}, ${borderColor.g}, ${
                borderColor.b
              }, ${borderColor.a})`,
            }}
          />
