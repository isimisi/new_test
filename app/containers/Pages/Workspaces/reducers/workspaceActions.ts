...
export const cvrWorkspace =
  (user: User, id: string, cvr: string, close: any, erstTypes: ErstTypes) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
...
export const postEdge =
  (user: User, workspace_id: string, edge: EdgeData, close: () => void) =>
  async (dispatch) => {
...
export const postSticky =
  (user: User, workspace_id: string, x: number, y: number) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
...
export const putSticky =
  (user: User, id: string, text: string) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
...
export const accessPublicWorkspace =
  ...
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
    ...
    try {
      ...
      dispatch({
        type: types.PUBLIC_ACCESS_WORKSPACE_FAILED,
        message: _message,
      });
    }
  };

export const signWorkspace =
  (
    user: User,
    id: string,
...
export const saveAnalysis =
  (user: User, id: string, output: string, subgraph: string) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
...
export const cvrWorkspacePublic =
  (user: User, id: string, cvr: string, erstTypes: ErstTypes) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
...
export const workspacePowerpoint =
  (user: User, id: string, label: string, elements: any[], stopLoading: () => void) =>
  async () => {
...
export const mapUncertainCompanies =
  (user: User, id: string, uncertainCompanies: any, erstTypes: ErstTypes) =>
  async (dispatch: ThunkDispatch<IImmutableWorkspaceState, any, WorkspaceActions>) => {
    dispatch({ type: types.GET_CVR_NODES_LOADING });
