...
export default interface IImmutableStateMap<S> extends Map<string, any> {
  ...
  delete<K extends keyof S>(key: K): this;
  remove<K extends keyof S>(key: K): this;
  ...
  merge<K extends keyof S, KC, VC>(
    ...collections: Array<Iterable<KC, VC>>
  ): Map<K | KC, S[K] | VC>;
  merge<K extends keyof S, C>(
  ...
  set<K extends keyof S>(key: K, value: S[K]): this;
  ...
  withMutations<K extends keyof S>(mutator: (mutable: Map<K, S[K]>) => any): this;
}
